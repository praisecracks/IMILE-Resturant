...
export default function Menu() {
  ...
  return (
    <section id="menu" className="py-32 px-6 md:px-12 bg-graphite relative overflow-hidden">
      <div className="max-w-screen-2xl mx-auto">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20 gap-8">
            <div>
              <h2 className="text-5xl md:text-7xl font-display font-light mb-6">CURATED<br /><span className="text-gold font-serif italic">FLAVORS</span></h2>
        ...
        <div className="mt-24 text-center">
            <button className="px-12 py-5 rounded-full border border-gold/30 text-xs uppercase tracking-[0.3em] hover:bg-gold hover:text-black transition-all duration-700 glow-amber group">
